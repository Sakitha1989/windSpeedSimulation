...
# function returns a p-value 
# x is the input multivariate time series

test_stationarity<-function(x,Boot=200){
  ...
  #print(kz)
  pval1 <- 1-pchisq(statistik_wb[m_max+1],df=m_opt_wb*d*(d+1))
  pval2 <- 1-pchisq(statistik[m_max+1],df=m_opt*d*(d+1))
  
  #return(list(pval = pval,stat = statistik_wb[m_max+1]))
